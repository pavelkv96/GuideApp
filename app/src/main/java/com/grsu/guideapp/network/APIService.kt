...
interface APIService {
    ...
    suspend fun getListRoutes(): Response<com.grsu.guideapp.network.pojo.Root>

    @GET("mobile/route/{id}/objects?Lang=all")
    suspend fun getPOIs(@Path("id") routeId: Long): Response<List<com.grsu.guideapp.network.pojo.AbstractObject>>
