...
public class Crypto {
    ...
    @NonNull
    public static List<LatLng> decodeLL(String encodedString) {
        return decodel(encodedString);
    }

    @NonNull
    public static LatLng decodePL(String encodedString) {
        return decodel(encodedString).get(0);
    }

    @NonNull
    private static List<LatLng> decodel(final String encodedString) {
