...
class RouteDetailsFragment : BaseMapFragment(), OnReceiverResponse {
    companion object {
    ...
    private val model: RouteDetailsViewModel by viewModels { factory }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        //TODO remove it
        view.findViewById<MaterialButton>(R.id.go_to_new).setOnClickListener {
            navigate(RouteDetailsFragmentDirections.actionRouteDetailsToRouteMap(args.routeId, args.title))
        }
        return view
    }
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            ...
            R.id.fab_base_map_places -> navigate(RouteDetailsFragmentDirections.actionRouteDetailsToOrder())
        }
    }
