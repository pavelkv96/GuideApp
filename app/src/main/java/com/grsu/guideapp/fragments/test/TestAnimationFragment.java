...
public class TestAnimationFragment extends BaseFragment<TestPresenter> implements TileProvider,
        OnMapReadyCallback, TestViews, OnChoiceItemListener, OnMultiChoiceListDialogFragment,
